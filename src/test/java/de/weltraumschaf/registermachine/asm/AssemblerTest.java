...
public class AssemblerTest {
    ...
    public void assamble_mainFunctionWithConstants() throws IOException, AssemblerSyntaxException {
        ...
        assertThat(bytecode, is(new byte[]{
            ...
            0x6d, 0x61, 0x69, 0x6e, 0x5f, 0x66, 0x75, 0x6e, // source name
            0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x77, 0x69, // source name
            0x74, 0x68, 0x5f, 0x63, 0x6f, 0x6e, 0x73, 0x74, // source name
            0x61, 0x6e, 0x74, 0x73, 0x2e, 0x63, 0x74, 0x61, // source name
            0x73, 0x6d, // source name
            // function [0] definition (level 0)
            0x01, // nups
            0x02, // numparams
    ...
    public void assamble_mainFunctionWithCodeVariablesAndConstants() throws IOException, AssemblerSyntaxException {
        ...
        assertThat(bytecode, is(new byte[]{
            (byte) 0xca, 0x7e, // singature
            0x02, 0x00, // version
            0x30, 0x00, 0x00, 0x00, // source name length
            0x6d, 0x61, 0x69, 0x6e, 0x5f, 0x66, 0x75, 0x6e, // source name
            0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x77, 0x69, // source name
            0x74, 0x68, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x5f, // source name
            0x76, 0x61, 0x72, 0x73, 0x5f, 0x61, 0x6e, 0x64, // source name
            0x5f, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x61, 0x6e, // source name
            0x74, 0x73, 0x2e, 0x63, 0x74, 0x61, 0x73, 0x6d, // source name
            // function [0] definition (level 0)
            0x01, // nups
            0x02, // numparams
            0x03, // isVararg
    ...
    @Test
    @Ignore
    public void assamble_mainFunctionWithCodeVariablesConstantsAndFunctions()
        throws IOException, AssemblerSyntaxException {
        final byte[] bytecode =
                createAndVerifyByteCodeFile("main_function_with_code_vars_constants_and_functions.ctasm").toArray();
        assertThat(bytecode.length, is(95));
        assertThat(bytecode, is(new byte[]{
            (byte) 0xca, 0x7e, // singature
            0x02, 0x00, // version
